...
function white_label_free_upgrade()
{
    ...
    <div class="white_label-subsection white_label-upgrade-tab">
        ...
        <p>
        Change individual plugin details (name, description, links, etc.) that display on the Plugins screen.
        </p>
        ...
        <a class="button-primary" href="https://whitewp.com/pro?utm_source=plugin_white_label&utm_content=upgrade_tab" target="_blank">Upgrade to White Label Pro</a>
	</div>
    ';
}
...
function white_label_free_sidebar($settings)
{
    ...
    $upgrade = [
        ...
        'content' => __(
            'Give your clients and users an even better WordPress experience with <a href="https://whitewp.com/pro?utm_source=plugin_white_label&utm_content=upgrade" target="_blank">White Label Pro</a>.
			...
			<a class="button-primary button-white_label" href="https://whitewp.com/pro?utm_source=plugin_white_label&utm_content=documentation" target="_blank">Upgrade to White Label Pro</a>',
            'white-label'
        ),
    ];
