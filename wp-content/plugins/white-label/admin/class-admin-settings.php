...
class white_label_Admin_Settings
{
    ...
    public function settings($get_part = false)
    {
        ...
        $desc_sidebar_menus_section = __('Hide sidebar menu items for non-White Label Administrators. Rename sidebar menus by upgrading to <a href="https://whitewp.com/pro?utm_source=plugin_white_label&utm_content=sidebar_menus" target="_blank">White Label Pro</a>.', 'white-label');
        ...
        $fields['white_label_visual_tweaks'] = [
            ...
            [
                'name' => 'admin_footer_credit_section',
    ...
    public function plugin_page()
    {
        ...
        echo '<h2>White Label '.__('Settings', 'white-label').'</h2>';
    ...
    {
        wp_enqueue_style('white-label-dashboard', plugins_url('assets/css/white-label-dashboard.css', dirname(__FILE__)), null, '2.5.2');
        ...
        // White Label
        wp_enqueue_style('white-label', plugins_url('assets/css/white-label.css', dirname(__FILE__)), null, '2.5.2');
        wp_enqueue_script('white-label', plugins_url('assets/js/white-label.min.js', dirname(__FILE__)), ['jquery'], '2.5.2');
    }
}
