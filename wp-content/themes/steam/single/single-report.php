...
<?php
    ...
    $tag = get_field('tag');
    $report_files = get_field('report_files');
...
<div data-aos="fade-up" class="bg-white">
    ...
    <div class="lg:w-2/3 lg:pl-24 4xl:pl-96 p-8 py-24">
        <p class="text-lsc-lightgray"><span class="mr-16"><?php echo $report_date ?></span><span><?php echo $tag ?></span></p>
    ...
    <div class="lg:w-1/3 bg-lsc-gray lg:pr-24 4xl:pr-96 p-8 py-24">
        <?php if( get_field('report_files') ): ?>    
        <?php while( the_repeater_field('report_files') ): ?> 
